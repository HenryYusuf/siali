<div class="container">
    <nav class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3">
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            <li><a href="{{ url('/') }}"
                    class="nav-link px-2 {{ Request::is('/') ? 'link-secondary' : (Request::is('search-alumni') ? 'link-secondary' : 'link-dark') }}">Home</a>
            </li>
            <li><a href="{{ url('/career') }}"
                    class="nav-link px-2 {{ Request::is('career') ? 'link-secondary' : (Request::is('career/*') ? 'link-secondary' : 'link-dark') }}">Career</a>
            </li>
            <li><a href="{{ url('/faq') }}"
                    class="nav-link px-2 {{ Request::is('faq') ? 'link-secondary' : 'link-dark' }}">FAQs</a></li>
            <li><a href="{{ url('/about') }}"
